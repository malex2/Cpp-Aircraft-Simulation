...
RCActuatorModel::RCActuatorModel(ModelMap *pMapInit, bool debugFlagIn) : ActuatorModelBase(pMapInit, debugFlagIn)
{
    ...
    // Create Actuators
    actuators[de] = new Servo(pMap, debugFlag, actuators_init[de]);
    actuators[da] = new Servo(pMap, debugFlag, actuators_init[da]);
    actuators[dr] = new Servo(pMap, debugFlag, actuators_init[dr]);
    ...
    static_cast<Servo*>(actuators[de])->setTimeConstant( servoTau[de] );
    static_cast<Servo*>(actuators[da])->setTimeConstant( servoTau[da] );
    static_cast<Servo*>(actuators[dr])->setTimeConstant( servoTau[dr] );
    
    static_cast<Servo*>(actuators[de])->setDt( dynamicsInterval_init );
    static_cast<Servo*>(actuators[da])->setDt( dynamicsInterval_init );
    static_cast<Servo*>(actuators[dr])->setDt( dynamicsInterval_init );
  
    static_cast<Servo*>(actuators[de])->setMaxRate( servoMaxRate[de] );
    static_cast<Servo*>(actuators[da])->setMaxRate( servoMaxRate[da] );
    static_cast<Servo*>(actuators[dr])->setMaxRate( servoMaxRate[dr] );
...
// Servo
// **********************************************************************
Servo::Servo(ModelMap *pMapInit, bool debugFlagIn, double init_position) : ActuatorTypeBase(pMapInit, debugFlagIn, init_position)
{
    pMap = pMapInit;
    debugFlag = debugFlagIn;
...
void Servo::updateDynamics(void)
{
