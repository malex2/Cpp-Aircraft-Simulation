...
// Initial States
const float velNED_init[3]  = {5, 0, 0};
...
const float actuators_init[4]   = {0.0,0.0,0.0,1.0}; //{de,da,dr,dT}
...
const bool testDynamics  = true; // Generate desired dynamics and test propogation from inital conditions
...
const float minAlpha = -25;
const float maxAlpha = 25;
