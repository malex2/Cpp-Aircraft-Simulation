...
private:
    ...
    */
    ...
    double actuatorTimes[nActuators][lengthTable] = {
        {0, 5, 7, 10, 10.15, 10.3, 29, 29.15, 29.3},
        {0, 5, 7, 10, 10.15, 10.3, 29, 29.15, 29.3},
        {0, 5, 7, 10, 10.15, 10.3, 29, 29.15, 29.3},
        {0, 5, 7, 10, 10.15, 10.3, 29, 29.15, 29.3}
    };
    ...
    double actuatorValues[nActuators][lengthTable] = {
        {0, 0.7, 0.6, 0.605 , 0.595, 0.6, 0.595, 0.605, 0.6}, // front left
        {0, 0.7, 0.6, 0.605 , 0.595, 0.6, 0.595, 0.605, 0.6}, // front right
        {0, 0.7, 0.6, 0.595 , 0.605, 0.6, 0.605, 0.595, 0.6}, // rear right
        {0, 0.7, 0.6, 0.595 , 0.605, 0.6, 0.605, 0.595, 0.6}  // rear left
    };
...
// ServoMotor
// **********************************************************************
class ServoMotor : public ActuatorTypeBase
{
public:
    ServoMotor(ModelMap *pMapInit, bool debugFlagIn = false, double init_position = 0.0);
